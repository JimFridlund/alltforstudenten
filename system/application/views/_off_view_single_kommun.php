...
<div class="image">
			<?php if($ad['logo'] != ""): ?>
				...
				?>
                <div class="tTip" id="cloud1" title="<?php if($ad['text_info'] != ""): ?><?php echo $ad['text_info']; ?><?php else: ?>Kontakta gärna oss för mer information.<?php endif; ?>">
                

                
                
				<img src="<?php echo base_url() ?>uploads/logo/<?php echo $ad['logo']; ?>" style="margin-top: <?php echo $margin; ?>px" height="<?php echo $size['height']; ?>" alt="" /></div>
			<?php else: ?>
			...
			<div class="info_empty">
				<a href="<?php echo base_url() ?>om-oss/kontakt">Vill du synas på studenten 2011?</a>
			</div>
			<?php endif; ?>
		</div>
		<?php endforeach;?>
