	...
	<div id="footer">
					...
					<div class="alignleft">Copyright &copy; 2011 - <? echo date("Y"); ?> <a href="<?php echo base_url() ?>">Studenten2023.se</a> - <a href="<?php echo base_url() ?>sitemap.xml">sitemap</a> | <a href="http://www.studeravidare.se">Studeravidare.se - Högskoleprov & Meritvärde</a> | <a href="http://www.foraldraledighet.se" title="Föräldraledig">Föräldraledighet</a> | <a href="http://www.xn--brllopet-o4a.se/">Bröllop</a></div>
