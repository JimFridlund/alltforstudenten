...
<script src="http://www.studenten2017.se/public/js/jquery.gmap.min.js" type="text/javascript"></script>
<!-- 
...
<div id="left">
	...
	<ul class="submenu single list" style="list-style-type: none;margin: 0;font-size: 14px;font-weight: bold;">	
		...
		<?php foreach($result as $data): ?>
			...
			<img src="http://www.studenten2017.se/public/images/icons/icon_mark.gif" alt="">
