...
<div id="left">
	<div class="left_box">
		...
		<dl>
			...
			<dt><label>Order id</label></dt>
			<dd>
				<input type="text" class="textfield" name="orderid" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
				<p>Fyll i annonsens order id.</p>
			</dd>
            
           	<dd class="separator"></dd>		


			<dt><label>Säljare</label></dt>
			<dd>
				<input type="text" class="textfield" name="seller" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
				<p>Fyll i säljare.</p>
			</dd>
            
           	<dd class="separator"></dd>	

			<dt><label>Löper ut</label></dt>
			<dd>
				<input type="text" class="textfield" name="date_expire" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
				<p>Hur länge är annonsen aktiv?</p>
			</dd>
			...
			<dt><label>Email</label><font style="color:#f00; font-size:10px; margin-left:20px;"><br />Lämna detta fält tomt</font></dt>
			<dd>
					
				<input type="text" class="textfield" name="email" /> 			
				<div class="req" title="Obligatoriskt fält">Obligatorisk</div>
				   
				<p>Fyll i företagets email adress</p>
			</dd>
...
<!--  Boka textfält -->
			<dt><label>Boka Textfält</label><font style="color:#f00; font-size:10px; margin-left:20px;"><br />Lämna detta fält tomt</font></dt>
			<dd>
              <textarea name="boka_text" class="textfield_text_info"></textarea>
		  </dd>
           ...
           <!-- End Boka textfält-->
            ...
            <dt><label>Textfält</label></dt>
			<dd>
              <textarea name="text_info" class="textfield_text_info"></textarea>
		  </dd>
			...
			<dd>
				<input type="text" class="textfield_medium" name="adress" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
			...
			<dd>
				<input type="text" class="textfield_postnr" name="postnr" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
				<input type="text" class="textfield_small" name="ort" />
			...
			<dd>
				<input type="text" class="textfield_medium" name="tel" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
			...
			<dd>
				<input type="text" class="textfield_medium" name="www" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
