...
<div id="left">
	<div class="left_box">
		...
		<dl>
			...
			<dd>
				<input type="text" class="textfield" name="orderid" value="<?php echo $data->orderid; ?>" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
			...
			<dd>
				<input type="text" class="textfield" name="seller" value="<?php echo $data->seller; ?>" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
				<p>Fyll i säljare.</p>
			</dd>
			...
			<dd>
				<input type="text" class="textfield" name="date_expire" value="<?php echo $data->date_expire; ?>" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
				<p>När löper annons ut?</p>
			</dd>
...
<!--  EMAIL -->
			...
			<dd>
				<input type="text" class="textfield" name="email" value="<?php echo $data->email; ?>" /> <div class="req" title="Obligatoriskt fält">Obligatorisk</div>
         ...
         <!--  END EMAIL -->
<!--  Boka textfält -->
	<dt><label>Boka Textfält</label></dt>
			<dd>
            
             <textarea name="boka_text"  class="textfield_text_info" ><?php echo $data->boka_text; ?></textarea> 
...
<!--  END Boka textfält -->
			...
			<dd>
             ...
             <textarea name="text_info"  class="textfield_text_info" ><?php echo $data->text_info; ?></textarea> 
