...
$config['DX_website_name'] = ' app';
$config['DX_webmaster_email'] = 'info@identa.se';
...
$config['DX_deny_uri'] = '/anvandare/deny/';
$config['DX_login_uri'] = '/anvandare/loggain/';
$config['DX_banned_uri'] = '/anvandare/banned/';
$config['DX_activate_uri'] = '/anvandare/activate/';
$config['DX_reset_password_uri'] = '/anvandare/reset_password/';
...
// URI Locations
$config['DX_logout_uri'] = '/anvandare/loggaut/';
$config['DX_register_uri'] = '/anvandare/registrera/';
$config['DX_forgot_password_uri'] = '/anvandare/forgot_password/';
$config['DX_change_password_uri'] = '/anvandare/change_password/';
$config['DX_cancel_account_uri'] = '/anvandare/cancel_account/';

// Forms view
$config['DX_login_view'] = 'anvandare/login_form';
$config['DX_register_view'] = 'anvandare/register_form';
$config['DX_forgot_password_view'] = 'anvandare/forgot_password_form';
$config['DX_change_password_view'] = 'anvandare/change_password_form';
$config['DX_cancel_account_view'] = 'anvandare/cancel_account_form';

// Pages view
$config['DX_deny_view'] = 'anvandare/general_message';
$config['DX_banned_view'] = 'anvandare/general_message';
$config['DX_logged_in_view'] = 'anvandare/general_message';
$config['DX_logout_view'] = 'anvandare/general_message';

$config['DX_register_success_view'] = 'anvandare/general_message';
$config['DX_activate_success_view'] = 'anvandare/general_message';
$config['DX_forgot_password_success_view'] = 'anvandare/general_message';
$config['DX_reset_password_success_view'] = 'anvandare/general_message';
$config['DX_change_password_success_view'] = 'anvandare/general_message';

$config['DX_register_disabled_view'] = 'anvandare/general_message';
$config['DX_activate_failed_view'] = 'anvandare/general_message';
$config['DX_reset_password_failed_view'] = 'anvandare/general_message';
